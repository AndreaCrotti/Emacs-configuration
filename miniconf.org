...
** Spelling functions
# TODO: make it easier to manage and to scroll through in general
#+begin_src emacs-lisp :tangle yes
...
** Enable semantic everywhere it's possible
#+begin_src emacs-lisp :tangle yes
...
#+begin_src emacs-lisp :tangle yes
  ...
  ;; senator
  (global-set-key "\C-cj" 'senator-jump)
  ...
  (global-set-key (kbd "M-<right>") 'elscreen-previous)
#+end_src
