...
# FIXME: also from org mode we should be able to use elscreen correctly
# FIXME: see if it's possible to solve the click problem in Elscreen
...
#+begin_src emacs-lisp :tangle yes
  (defcustom private-file
    (concat base "private.el")
...
#+begin_src emacs-lisp :tangle yes
  ; TODO: if possible refactor this better
  (defconst sysop
    (cond
...
** Info configuration
#+begin_src emacs-lisp :tangle yes
  (add-to-list 'Info-default-directory-list (make-conf-path "org-mode/share/info/"))
#+end_src
...
** Elim
#+begin_src emacs-lisp :tangle yes
  (add-to-list 'load-path (make-conf-path "elim/elisp"))
  (setq elim-directory (make-conf-path "elim"))
#+end_src
