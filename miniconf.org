...
** Info configuration
#+begin_src emacs-lisp :tangle yes
  ;FIXME: still doesn't work as desired
...
*** Define templates
#+begin_src emacs-lisp :tangle yes
  ;TODO:  make those two more interesting
...
#+begin_src emacs-lisp :tangle yes
  ...
  (let ((orig (make-conf-path "yasnippet/snippets/"))
        (submod (expand-file-name "~/Documents/my-snippets")))
    (setq yas/root-directory (list submod orig)))
...
*** [[http://zagadka.vm.bytemark.co.uk/magit/][GIT]]
...
#+begin_src emacs-lisp :tangle yes
  ...
  ;(remove-hook 'magit-log-edit-mode-hook 'turn-on-orgtbl)
  ;(remove-hook 'magit-log-edit-mode-hook 'turn-on-orgstruct)
#+end_src
...
#+begin_src emacs-lisp :tangle no
  ...
  (load-file (concat (make-conf-path "tramp/lisp/") "tramp.el"))
