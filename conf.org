...
#+begin_src emacs-lisp :tangle modules/ca-aliases.el
...
** Custom settings
#+begin_src emacs-lisp :tangle ca-init.el
...
#+begin_src emacs-lisp :tangle modules/ca-customs.el
...
*** Mapcar head
#+begin_src emacs-lisp :tangle modules/ca-functions.el
...
#+begin_src emacs-lisp :tangle modules/ca-cedet.el
  (defun ca-next-tag ()
    (interactive)
...
#+begin_src emacs-lisp :tangle modules/ca-init.el
  (let
...
*** Select all from an alist
    This function is used in yasnippet, so there should be an explicit dependency
#+begin_src emacs-lisp :tangle modules/ca-functions.el
...
#+begin_src emacs-lisp :tangle modules/ca-prog-mode.el
...
#+begin_src emacs-lisp :tangle modules/ca-environment.el
  (defconst ca-sysop
...
** Dired settings
#+begin_src emacs-lisp :tangle modules/ca-dired.el
...
#+begin_src emacs-lisp :tangle modules/ca-bookmarks.el
   (require 'bookmark+)
#+end_src

** Desktop mode
#+begin_src emacs-lisp :tangle modules/ca-desktop.el
  (require 'desktop)
...
#+begin_src emacs-lisp :tangle modules/ca-misc.el
   (require 'saveplace)
#+end_src
...
#+begin_src emacs-lisp :tangle modules/ca-org.el
...
#+begin_src emacs-lisp :tangle modules/ca-packages.el
  ; Other autoloads
...
#+begin_src emacs-lisp :tangle modules/ca-frames.el
...
** Color theme setting
#+begin_src emacs-lisp :tangle modules/ca-themes.el
  (require 'color-theme)
...
#+begin_src emacs-lisp :tangle modules/ca-fonts.el
...
#+begin_src emacs-lisp :tangle modules/ca-yas.el
  (require 'yasnippet)
...
#+begin_src emacs-lisp :tangle modules/ca-auto-complete.el
  ;;; Require
...
*** Gtags
#+begin_src elisp :tangle modules/ca-prog-mode.el
...
** VC
#+begin_src emacs-lisp :tangle modules/ca-vc.el
  (setq
...
#+begin_src emacs-lisp :tangle modules/ca-clojure.el
...
** Ess
#+begin_src emacs-lisp :tangle modules/ca-other-modes.el
...
#+begin_src emacs-lisp :tangle modules/ca-c.el
...
*** Paths and extensions
    This dirty hack is useful to force the use of python-mode.el

#+begin_src emacs-lisp :tangle modules/ca-python.el
...
#+begin_src emacs-lisp :tangle modules/ca-java.el
...
** Ruby mode
*** General settings
#+begin_src emacs-lisp :tangle modules/ca-ruby.el
...
#+end_src
* Other modes
** Enable NSIS mode for installers
#+begin_src emacs-lisp :tangle modules/ca-other-modes.el
...
** Command frequency mode
   This might be customizable in various different ways
#+begin_src elisp :tangle modules/ca-other-modes.el
...
#+end_src
   ...
   Open automatically some log files to analyze them
#+begin_src emacs-lisp :tangle modules/ca-other-modes.el
...
* Latex
** Configuring Auctex
   Auctex is much more powerful than the default latex mode, enabling
   it using pdf as default mode

#+begin_src emacs-lisp :tangle modules/ca-latex.el
...
* Communication
#TODO: make gmail the default relay or use msmtp to change server if possible
** Mail settings
*** General settings for message creation

#+begin_src emacs-lisp :tangle modules/ca-network.el
...
* Flymake
** Setting up flymake
#+begin_src emacs-lisp :tangle modules/ca-flymake.el
  (require 'flymake)
